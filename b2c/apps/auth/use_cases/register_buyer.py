...
from apps.auth.schemas.request import RegisterBuyerRequestSchema
...
from shared.auth_lib import JwtService, PasswordHasher, UserRole


class RegisterBuyerUseCase:
    """Регистрация покупателя — public endpoint, без авторизации.

    Бизнес-правила:
    - role всегда BUYER (фиксируется в use-case, не из тела).
    - При дубликате email → 409 EMAIL_ALREADY_EXISTS.
    - На выходе пара токенов + user_id.
    """
